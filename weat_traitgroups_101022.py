...
def s_weat(X, A, B, permt = 0, perm_n = 10000, table = "coming_of_age", cohesion_test = False,
...
for vector, table in zip(vectors, tablenames):
	...
	if __name__ == '__main__':
		...
		with open("traitlist_groups.txt", 'r') as f:
			...
			for line in f:
				...
				try:
					result_dict = s_weat(attribute, vecs["male"], vecs["female"],  # changed attribute to a "vector" here
		...
		dfname = "embeddings_singletraits_groups_" + table + ".csv"
